...
class FhaHourlyDefaultsTest extends TestBaseRest {

    private final IAFolderBuilder folderBuilderHourlyDefaults = createFolderBuilder("IARFhaHrDef");

    @BeforeAll
    void uploadLoanDocAndIncomeDocuments() {
        folderBuilderHourlyDefaults.setMortgageAppliedFor(MortgageType.FHA)
    ...
    @Description("IA-2447 Check If Hourly Income Defaults Are Selected Correctly For Documents With All Values")
    void checkIfHourlyIncomeDefaultsAreSelectedCorrectlyForDocumentsWithAllValues(BigDecimal prevW2YtdAmount, BigDecimal twoPrevW2YtdAmount,
    ...
    @Description("IA-2460 Check If Hourly Income Defaults Are Selected Correctly For Documents With One Value Missing")
    void checkIfHourlyIncomeDefaultsAreSelectedCorrectlyForDocumentsWithOneValueMissing(BigDecimal prevW2YtdAmount, BigDecimal twoPrevW2YtdAmount,
                                                                                        BigDecimal pstbRate, BigDecimal pstbHours, BigDecimal pstbYtdAmount,
                                                                                        BigDecimal voeRate, BigDecimal voeHours, BigDecimal voeYtdAmount,
                                                                                        SummaryDocumentType ytdDefaultDoc, AnnualSummaryIncomeType ytdAnnualSummaryIncomeType, IncomeAvg haSelection) {
        setDocumentvaluesAndUploadThemToFolder(prevW2YtdAmount, twoPrevW2YtdAmount, pstbRate, pstbHours, pstbYtdAmount, voeRate, voeHours, voeYtdAmount);
    ...
    @Description("IA-2461 Check If Hourly Income Defaults Are Selected Correctly For Documents With Two Values Missing")
    void checkIfHourlyIncomeDefaultsAreSelectedCorrectlyForDocumentsWithTwoValuesMissing(BigDecimal prevW2YtdAmount, BigDecimal twoPrevW2YtdAmount,
                                                                                         BigDecimal pstbRate, BigDecimal pstbHours, BigDecimal pstbYtdAmount,
                                                                                         BigDecimal voeRate, BigDecimal voeHours, BigDecimal voeYtdAmount,
                                                                                         SummaryDocumentType ytdDefaultDoc, AnnualSummaryIncomeType ytdAnnualSummaryIncomeType, IncomeAvg haSelection) {
        setDocumentvaluesAndUploadThemToFolder(prevW2YtdAmount, twoPrevW2YtdAmount, pstbRate, pstbHours, pstbYtdAmount, voeRate, voeHours, voeYtdAmount);
