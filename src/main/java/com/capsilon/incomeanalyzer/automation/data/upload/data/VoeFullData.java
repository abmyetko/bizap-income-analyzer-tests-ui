...
public class VoeFullData extends DocumentData<VoeFullData> {
    ...
    public VoeFullData(String documentName) {
        super(documentName);
    }

    public VoeFullData setExecutionDate(String executionDate) {
        this.signatureDate = executionDate;
        return this;
    }
}
