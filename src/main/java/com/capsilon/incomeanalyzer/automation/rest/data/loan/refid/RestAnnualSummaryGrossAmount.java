...
public class RestAnnualSummaryGrossAmount {
    ...
    public List<FailureComparison> compareTo(RestAnnualSummaryGrossAmount anotherAnnualSummaryGrossAmount) {
        return compareTo(anotherAnnualSummaryGrossAmount, "", "", "", "");
    }

    public List<FailureComparison> compareTo(RestAnnualSummaryGrossAmount anotherAnnualSummaryGrossAmount, String applicantName, String employerName, String incomeType, String year) {
        List<FailureComparison> failList = new ArrayList<>();
        failList.add(new FailureComparison(String.format("applicants(%s).incomes(%s).parts(%s).incomes(%s).annualSummary.grossAmount.value", applicantName, employerName, incomeType, year),
                this.getValue(), anotherAnnualSummaryGrossAmount.getValue()));
        return failList;
    }
}
