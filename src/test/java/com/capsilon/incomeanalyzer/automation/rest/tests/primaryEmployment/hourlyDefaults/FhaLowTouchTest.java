...
@ResourceLock(value = "FhaLowTouchTest")
public class FhaLowTouchTest extends TestBaseRest {

    private final IAFolderBuilder folderBuilderHourlyDefaults = createFolderBuilder("IARFHrHALT");
    ...
    private Stream oneDocCappedHoursTestCases() { // ytdDocument, ytdIncomeSelection, prevYrDocument, predictedHa
        return Stream.of(
                ...
                of(PAYSTUB, AVG, W2, BASEPAY_YTD_AVG_PLUS_PREV_TWO_YRS)
        );
    }
    ...
    @Order(1)
    @Description("IA-2462 Check If Historical Average Is Defaulted Correctly For Different Income Selections For Fha Loan")
    ...
    @Test
    @Order(2)
    @Description("IA-2463 Check If Ytd Historical Average Ytd Can Be Selected Manually For Fha Loan")
    ...
    @Test
    @Order(2)
    @Description("IA-2463 Check If Ytd Historical Average Ytd Plus Prior Year Can Be Selected Manually For Fha Loan")
    ...
    @Test
    @Order(2)
    @Description("IA-2463 Check If Ytd Historical Average Ytd Plus Two Years Prior Can Be Selected Manually For Fha Loan")
